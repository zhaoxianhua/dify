...
def upgrade():
    ...
    if _is_pg(conn):
        ...
        op.execute("""
            CREATE TABLE documents (
                ...
                dataset_process_rule_id CHAR(36) NULL,
                batch VARCHAR(255) NOT NULL,
                name VARCHAR(255) NOT NULL,
                created_from VARCHAR(255) NOT NULL,
                created_by CHAR(36) NOT NULL,
                created_api_request_id CHAR(36) NULL,
                created_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
                processing_started_at DATETIME NULL,
                file_id TEXT NULL,
                word_count INT NULL,
                parsing_completed_at DATETIME NULL,
                cleaning_completed_at DATETIME NULL,
                splitting_completed_at DATETIME NULL,
                tokens INT NULL,
                indexing_latency FLOAT NULL,
                completed_at DATETIME NULL,
    ...
    if _is_pg(conn):
        ...
        op.execute("""
            CREATE TABLE providers (
                ...
                quota_type VARCHAR(40) NULL DEFAULT '',
    ...
    if _is_pg(conn):
        ...
        op.execute("""
            CREATE TABLE messages (
                ...
                total_price DECIMAL(10,7) NULL,
                currency VARCHAR(255) NOT NULL,
                from_source VARCHAR(255) NOT NULL,
                from_end_user_id CHAR(36) NULL,
    ...
    if _is_pg(conn):
        ...
        sa.Column('authed', sa.Boolean(), server_default=sa.text('false'), nullable=False),
        sa.Column('tools', sa.Text(), server_default=sa.text("'[]'"), nullable=False),
        sa.Column('created_at', sa.DateTime(), server_default=sa.text('CURRENT_TIMESTAMP(0)'),nullable=False),
        sa.Column('updated_at', sa.DateTime(), server_default=sa.text('CURRENT_TIMESTAMP(0)'),nullable=False),
        sa.PrimaryKeyConstraint('id', name='tool_mcp_providers_pkey'),
        ...
        CREATE TABLE tool_mcp_providers (
            ...
            created_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
            updated_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
            UNIQUE KEY unique_mcp_provider_server_url (tenant_id, server_url_hash),
            UNIQUE KEY unique_mcp_provider_name (tenant_id, name),
            UNIQUE KEY unique_mcp_provider_server_identifier (tenant_id, server_identifier)
        );
        """)
